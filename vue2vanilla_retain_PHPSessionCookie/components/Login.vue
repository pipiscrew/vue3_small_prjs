<template>
  <div>
    <div
      ...
      v-bind:class="[messagehaserror ? 'alert-danger' : 'alert-success']"
      class="alert"
      role="alert"
    >
      {{ message }}
    ...
    <div class="col-md-2 offset-md-5">
      <div class="form-group">
        ...
        <input
          v-on:keyup.13="login()"
          v-model="username"
          v-bind:class="[usernameinvalid ? 'is-invalid' : '']"
      ...
      <div class="form-group">
        ...
        <input
          ...
          v-on:keyup.13="login()"
          v-model="password"
          v-bind:class="[passwordinvalid ? 'is-invalid' : '']"
          class="form-control form-control-lg"
        />
      </div>
      <br />
      <button @click="login" class="btn btn-lg btn-outline-primary">
        Sign In
      </button>
    </div>
  </div>
